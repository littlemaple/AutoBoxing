...
class DevController extends \App\Http\Controllers\Controller{
    ...
    private $data_sets = ["1"=>"陈娇颖","2"=>"郑升","3"=>"沈佳","4"=>"陈倩倩","5"=>"亚红姐姐"];
    private $show_sets=['happy valentine day!'];
    private $valid_name = "you could not set other name!";
    
    public function show(Request $request){
        $uri = urldecode(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));
        $result = array_merge([],$this->show_sets);
        array_unshift($result,$this->get_valid_name());
